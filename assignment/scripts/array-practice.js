...
let foodArray = ['cheese', 'pasta', 'bagels', 'fish'];
...
console.log('Favorite foods are now', foodArray);
...
foodArray.unshift('potatoes');
console.log(`Added favorite food to the beginning: ${foodArray}`);
